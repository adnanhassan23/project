        ...
        <div className="Grey R25 p-4">
          ...
          <div className="d-flex pt-2">
            <div className="me-auto w-50">
              <p className="Font14 m-0 fw-bold">{this.props.Profile.Position}</p>
              <p className="Font14 m-0">Positions</p>
            </div>
            <div className="me-auto w-50">
          ...
          <div className="d-flex pt-2">
            <div className="me-auto w-50">
              ...
              <p className="Font14 m-0">Total Trades opened</p>
            </div>
            <div className="me-auto w-50">
          ...
          <div className="d-flex pt-2">
            <div className="me-auto w-50">
              <p className="Font14 m-0 fw-bold">{this.props.Profile.followers}</p>
              <p className="Font14 m-0">Followers</p>
            </div>
            <div className="me-auto w-50">
              <p className="Font14 m-0 Purple fw-bold">{this.props.Profile.CopiedBy}</p>
              <p className="Font14 m-0">Traders Coping You</p>
            </div>
          </div>
        </div>
      </div>
